...
namespace Acme.BookStoreTheme.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BookStoreThemeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BookStoreThemeEfCoreEntityExtensionMappings to extend the IdentityUser entity
